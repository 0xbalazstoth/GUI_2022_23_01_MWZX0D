    ...
    public class TilemapLogic : ITilemapLogic
    {
        ...
        public void UpdateItemAnimationTextures()
        {
            ...
            for (int i = 0; i < gameModel.CollectibleItems.Count; i++)
            {
                ...
                gameModel.CollectibleItems[i].Item.TextureRect = (gameModel.CollectibleItems[i] as CollectibleItemModel).Animations[gameModel.CollectibleItems[i].type].TextureRect;
            }
        }
    }
}
